...
def create_folders(data, json_file_path):
    ...
    # Crea las subcarpetas week1, week2, week3, week4 y sus README con las descripciones
    ...
    lesson_counters = {'week1': 1, 'week2': 1, 'week3': 1, 'week4': 1}
